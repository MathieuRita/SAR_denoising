...
def main():
    ...
    model_name = 'loss_L1_view_L5_LM'           # 'ffdnet_gray' | 'ffdnet_color' | 'ffdnet_color_clip' | 'ffdnet_gray_clip'
    ...
    for idx, img in enumerate(L_paths):
        ...
        # ------------------------------------
        # (2) Noise_level with local_means
        # ------------------------------------
        ...
        sigma=(noise_level_img/255)*(sigma/sigma.max())
        img_E = model(img_L, sigma)
        img_E = util.tensor2uint(img_E*1.1)
